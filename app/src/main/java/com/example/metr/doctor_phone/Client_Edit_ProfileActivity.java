...
public class Client_Edit_ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client__edit__profile);
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Client_Edit_ProfileActivity.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                ...
                RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(Client_Edit_ProfileActivity.this,"Change Done",Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(Client_Edit_ProfileActivity.this,Client_HomeActivity.class);
