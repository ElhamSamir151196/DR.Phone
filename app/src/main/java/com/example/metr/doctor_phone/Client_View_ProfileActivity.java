...
public class Client_View_ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client__view__profile);
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Client_View_ProfileActivity.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
        ...
        Update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Client_View_ProfileActivity.this, Client_HomeActivity.class);
